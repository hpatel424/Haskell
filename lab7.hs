...
-- Left quotients on extended REs, computed directly by recursion.
...
leftq a (Let' c)
  | a == c = Star' Zero
  | otherwise = Zero
leftq a (Union' rs) = Union' [leftq a r | r <- rs]
leftq a (Cat' rs) = Union' $ help rs where
  help :: [RegExp'] -> [RegExp']
  help [] = [Zero]
  help (x:xs) = (Cat' ((leftq a x):xs)):(help xs)
leftq a (Star' r) = Cat' ((leftq a r):[Star' r])
...
solve ((l11:l1J) : rows) (l1':lI') = simp x1 : xI where
  ...
  six li1 l1j lij = Union' [Cat' [li1, Star' l11, l1'], lij]
...
{-
ghci>  toRE' "ab+b.a*+" 
Union' [Cat' [Union' [Let' 'a',Let' 'b'],Let' 'b'],Star' (Let' 'a')]
ghci> toRE' "0"
Zero
ghci> toRE' "1"
One
ghci> toRE' "ab.1+"
Union' [Cat' [Let' 'a',Let' 'b'],One]
-}
...
ghci> byp (toRE' "00.")
False
ghci> byp (toRE' "ab+b.a*+")
True
-}

{-
ghci> leftq 'a' (toRE' "ab+b.a*+")
Union' [Union' [Cat' [Union' [Star' Zero,Zero],Let' 'b'],Cat' [Zero],Zero],Cat' [Star' Zero,Star' (Let' 'a')]]
ghci> leftq 'a' (toRE' "ab.")
Union' [Cat' [Star' Zero,Let' 'b'],Cat' [Zero],Zero]
ghci> leftq 'b' (toRE' "a*")
Cat' [Zero,Star' (Let' 'a')]
ghci> leftq 'b' (toRE' "ba+")
Union' [Star' Zero,Zero]
ghci> leftq 'b' (toRE' "ba.")
Union' [Cat' [Star' Zero,Let' 'a'],Cat' [Zero],Zero]
ghci> leftq 'b' (toRE' "0")
Zero
ghci> leftq 'b' (toRE' "0b.")
Union' [Cat' [Zero,Let' 'b'],Cat' [Star' Zero],Zero]
ghci> leftq 'a' (toRE' "ab.0+")
Union' [Union' [Cat' [Star' Zero,Let' 'b'],Cat' [Zero],Zero],Zero]
-}

{-
ghci> toRE' "ab+b."
Cat' [Union' [Let' 'a',Let' 'b'],Let' 'b']
ghci> toRE' "ab.0+"
Union' [Cat' [Let' 'a',Let' 'b'],Zero]
ghci> simp (toRE' "ab+b.")
Union' [Cat' [Let' 'a',Let' 'b'],Cat' [Let' 'b',Let' 'b']]
ghci> toRE' "0a.b+"
Union' [Cat' [Zero,Let' 'a'],Let' 'b']
ghci> simp (toRE' "0a.b+")
Let' 'b'
-}
